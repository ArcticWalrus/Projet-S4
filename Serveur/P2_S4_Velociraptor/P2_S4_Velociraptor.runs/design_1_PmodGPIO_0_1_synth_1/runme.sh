...
HD_PWD='D:/OneDrive - USherbrooke/SESSIONS/S4/Projet/PROJECT_FILES/P2_S4_Velociraptor/P2_S4_Velociraptor.runs/design_1_PmodGPIO_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_PmodGPIO_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_PmodGPIO_0_1.tcl
