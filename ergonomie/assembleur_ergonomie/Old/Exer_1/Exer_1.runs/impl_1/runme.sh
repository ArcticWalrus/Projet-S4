...
HD_PWD='C:/Users/ArcticWalrus/Documents/GitHub/Projet-S4/ergonomie/assembleur_ergonomie/Exer_1/Exer_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Demo1_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Demo1_Top.tcl -notrace
