...
HD_PWD='C:/Users/ArcticWalrus/Documents/GitHub/Projet-S4/ergonomie/assembleur_ergonomie/Exer_1/Exer_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Demo1_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Demo1_Top.tcl
