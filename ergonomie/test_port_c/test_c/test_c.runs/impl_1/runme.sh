...
HD_PWD='D:/Projet-S4/ergonomie/test_port_c/test_c/test_c.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zybo_wrapper.tcl -notrace
