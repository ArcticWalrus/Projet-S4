...
HD_PWD='D:/Projet-S4/ergonomie/test_port_c/test_c/test_c.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zybo_wrapper.tcl
