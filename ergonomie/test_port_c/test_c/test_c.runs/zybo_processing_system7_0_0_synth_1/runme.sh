...
HD_PWD='D:/Projet-S4/ergonomie/test_port_c/test_c/test_c.runs/zybo_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zybo_processing_system7_0_0.tcl
