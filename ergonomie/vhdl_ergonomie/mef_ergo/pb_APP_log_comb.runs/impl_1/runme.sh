...
HD_PWD='C:/ProjetsFPGA/projets_vivado/pb_APP_log_comb/pb_APP_log_comb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log labo_adder4b_sol.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source labo_adder4b_sol.tcl -notrace
