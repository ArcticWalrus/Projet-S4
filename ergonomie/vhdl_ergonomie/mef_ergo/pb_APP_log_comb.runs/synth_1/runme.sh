...
HD_PWD='C:/ProjetsFPGA/projets_vivado/pb_APP_log_comb/pb_APP_log_comb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log labo_adder4b_sol.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source labo_adder4b_sol.tcl
